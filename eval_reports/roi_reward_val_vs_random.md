...
Generated: 2026-08-11 09:46:47  
Opponent: `random`  ·  Episodes per model: 10  ·  Action space: 5

## Trade-action summary (HIRE + SELL_WHEAT + BUY_WHEAT)

| Model | Trade % | Safe % | Win rate | Wins / Total |
|---|---|---|---|---|
| `roi_reward_val.zip` | **100.00%** | 0.00% | 100.00% | 10/10 |

## Detailed action counts

| Model | HOLD | HIRE | SELL | BUY | PASS | OTHER | Total |
|---|---|---|---|---|---|---|---|
| `roi_reward_val.zip` | 0 | 0 | 0 | 7190 | 0 | 0 | 7190 |
